# Generated by Django 3.2.16 on 2023-01-08 22:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, help_text='所属项目', null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.project', verbose_name='所属项目')),
            ],
            options={
                'verbose_name': '迭代',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='父工作项', null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.workitem', verbose_name='父工作项')),
                ('sprint', models.ForeignKey(blank=True, help_text='所属迭代', null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.sprint', verbose_name='所属迭代')),
            ],
            options={
                'verbose_name': '工作项',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_item', models.ForeignKey(blank=True, help_text='所属工作项', null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.workitem', verbose_name='所属工作项')),
            ],
            options={
                'verbose_name': '静态文件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='父评论', null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.comment', verbose_name='父评论')),
                ('work_item', models.ForeignKey(blank=True, help_text='所属工作项', null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.workitem', verbose_name='所属工作项')),
            ],
            options={
                'verbose_name': '用户评论',
